...
class FNoesisGuiRenderDevice : public Noesis::Render::RenderDevice
{
...
public:
	...
	class FNoesisGuiVSBase* VertexShaders[NUM_SHADERS];
	class FNoesisGuiPSBase* PixelShaders[NUM_SHADERS];
	FGlobalBoundShaderState BoundShaderStates[NUM_SHADERS];

	class FNoesisGuiRenderTarget* CurrentRenderTarget;

	FNoesisGuiRenderDevice();
	virtual ~FNoesisGuiRenderDevice();
