...
* The NoesisGUI SDK version 2.2.4. You can download it from [our website](https://noesisengine.com).
...
2. Download the NoesisGUI SDK version 2.2.4 from [our developer portal](https://www.noesisengine.com/forums/viewtopic.php?f=14&t=1491) and extract it into `[NoesisGUIRoot]/Source/Noesis/NoesisSDK`.
